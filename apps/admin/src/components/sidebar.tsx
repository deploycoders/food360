...
const navigation = [
  {
    ...
    items: [
      ...
      { label: "Órdenes", href: "/orders", icon: ShoppingBag, badge: 3 },
    ],
  },
  {
    title: "GESTIÓN DE MENÚ",
    items: [
      { label: "Platillos & Carta", href: "/menu", icon: UtensilsCrossed },
      { label: "Categorías", href: "/menu/categories", icon: Tags },
      { label: "Control de Stock", href: "/menu/stock", icon: Boxes },
    ],
  },
  {
    title: "ADMINISTRACIÓN",
    items: [
      { label: "Personal & Equipo", href: "/team", icon: Users },
